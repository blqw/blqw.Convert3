...
namespace blqw
{
    ...
    public partial class Convert3
    {
        ...
        private static string ToPinyin(char word)
        {
            ...
            {
                var pos = Array.IndexOf(_secondChinese, word.ToString());
                if (pos != decimal.MinusOne)
                {
                    return _secondPinYin[pos];
                }
            }
        ...
        /// 二级汉字数组
        /// </summary>
        private static readonly string[] _secondChinese =
        {
        ...
        /// 二级汉字对应拼音数组
        /// </summary>
        private static readonly string[] _secondPinYin =
        {
