...
namespace blqw.Converts
{
    ...
    public class CNameValueCollection : BaseTypeConvertor<NameValueCollection>
    {
        ...
        /// <returns> </returns>
        protected override NameValueCollection ChangeTypeImpl(IConvertContext context, object input, Type outputType,
            out bool success)
        {
        ...
        /// <param name="outputType"> 换转后的类型 </param>
        /// <param name="success"> 是否成功 </param>
        protected override NameValueCollection ChangeType(IConvertContext context, string input, Type outputType,
            out bool success)
        {
            input = input?.Trim();
        ...
        protected struct NVCollectiontBuilder : IBuilder<NameValueCollection, DictionaryEntry>
        {
            ...
            public NVCollectiontBuilder(IConvertContext context, Type type)
            {
                _context = context;
                _type = type;
                Instance = null;
