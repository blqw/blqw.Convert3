...
namespace blqw.Converts
{
    ...
    public class CUInt64 : SystemTypeConvertor<ulong>
    {
        ...
        protected override ulong ChangeType(IConvertContext context, string input, Type outputType, out bool success)
        {
            ulong result;
        ...
        /// <param name="outputType"> 换转后的类型 </param>
        /// <param name="success"> 是否成功 </param>
        protected override ulong ChangeTypeImpl(IConvertContext context, object input, Type outputType, out bool success)
        {
