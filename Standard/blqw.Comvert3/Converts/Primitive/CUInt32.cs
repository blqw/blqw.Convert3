...
namespace blqw.Converts
{
    ...
    public class CUInt32 : SystemTypeConvertor<uint>
    {
        ...
        protected override uint ChangeType(IConvertContext context, string input, Type outputType, out bool success)
        {
            uint result;
        ...
        /// <param name="outputType"> 换转后的类型 </param>
        /// <param name="success"> 是否成功 </param>
        protected override uint ChangeTypeImpl(IConvertContext context, object input, Type outputType, out bool success)
        {
