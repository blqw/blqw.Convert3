...
namespace blqw.Converts
{
    ...
    public class CInt16 : SystemTypeConvertor<short>
    {
        ...
        protected override short ChangeType(IConvertContext context, string input, Type outputType, out bool success)
        {
            short result;
        ...
        /// <param name="outputType"> 换转后的类型 </param>
        /// <param name="success"> 是否成功 </param>
        protected override short ChangeTypeImpl(IConvertContext context, object input, Type outputType, out bool success)
        {
            success = true;
