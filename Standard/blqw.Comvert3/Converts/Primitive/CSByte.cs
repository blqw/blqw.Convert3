...
namespace blqw.Converts
{
    ...
    public class CSByte : SystemTypeConvertor<sbyte>
    {
        ...
        protected override sbyte ChangeType(IConvertContext context, string input, Type outputType, out bool success)
        {
            sbyte result;
        ...
        /// <param name="outputType"> 换转后的类型 </param>
        /// <param name="success"> 是否成功 </param>
        protected override sbyte ChangeTypeImpl(IConvertContext context, object input, Type outputType, out bool success)
        {
