...
namespace blqw.Converts
{
    ...
    public class CDouble : SystemTypeConvertor<double>
    {
        ...
        protected override double ChangeType(IConvertContext context, string input, Type outputType, out bool success)
        {
            double result;
        ...
        /// <param name="outputType"> 换转后的类型 </param>
        /// <param name="success"> 是否成功 </param>
        protected override double ChangeTypeImpl(IConvertContext context, object input, Type outputType, out bool success)
        {
