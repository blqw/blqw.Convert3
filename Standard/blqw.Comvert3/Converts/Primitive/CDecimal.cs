...
namespace blqw.Converts
{
    ...
    public class CDecimal : SystemTypeConvertor<decimal>
    {
        ...
        protected override decimal ChangeType(IConvertContext context, string input, Type outputType, out bool success)
        {
            decimal result;
        ...
        /// <param name="outputType"> 换转后的类型 </param>
        /// <param name="success"> 是否成功 </param>
        protected override decimal ChangeTypeImpl(IConvertContext context, object input, Type outputType,
            out bool success)
        {
