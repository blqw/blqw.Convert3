...
namespace blqw.Converts
{
    ...
    public class CIList : BaseTypeConvertor<IList>
    {
        ...
        /// <returns> </returns>
        protected override IList ChangeTypeImpl(IConvertContext context, object input, Type outputType, out bool success)
        {
            success = true;
        ...
        /// <param name="outputType"> 换转后的类型 </param>
        /// <param name="success"> 是否成功 </param>
        protected override IList ChangeType(IConvertContext context, string input, Type outputType, out bool success)
        {
            input = input?.Trim();
        ...
        protected struct ListBuilder : IBuilder<IList, object>
        {
            ...
            public ListBuilder(Type type, IConvertContext context)
            {
                _type = type;
                _context = context;
                Instance = null;
