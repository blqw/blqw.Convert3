...
namespace blqw.Converts
{
    ...
    {
        protected override uint ChangeType(object input, Type outputType, out bool success)
        {
        ...
        protected override uint ChangeType(string input, Type outputType, out bool success)
        {
            uint result;
