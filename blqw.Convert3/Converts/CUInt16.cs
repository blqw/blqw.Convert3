...
namespace blqw.Converts
{
    ...
    {
        protected override ushort ChangeType(string input, Type outputType, out bool success)
        {
            ushort result;
        ...
        protected override ushort ChangeType(object input, Type outputType, out bool success)
        {
