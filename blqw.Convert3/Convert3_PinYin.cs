//该文件中的代码参考:http://www.cnblogs.com/cxd4321/p/4203383.html
...
namespace blqw
{
    ...
    public partial class Convert3
    {
        ...
        private static string ToPinyin(char word)
        {
            ...
            var arr = GB2312.GetBytes(word.ToString());
            ...
            {
                var pos = Array.IndexOf(_OtherChinese, word.ToString());
                if (pos != decimal.MinusOne)
                {
                    return _OtherPinYin[pos];
                }
            }
        ...
        /// 二级汉字数组
        /// </summary>
        private static readonly string[] _OtherChinese =
        {
        ...
        /// 二级汉字对应拼音数组
        /// </summary>
        private static readonly string[] _OtherPinYin =
        {
